 ...
 * https://github.com/topics/gif-library
 * 
 * @author jpvel
 *
 */
public class TwoEmotionTest {

	@Test
	public void createImage() throws IOException {
		
		String imagePath = this.getClass().getResource("512px-Hinweiszeichen_17a_empty.jpg").getPath();
		String text1 = "Marc : Do you know the best thing ";
		String text2 = "                                        about startups?";
		String text3 = "Ben : What ?";
		String text4 = "Marc: You only ever experience two";
		String text5 = "emotions - euphoria & terror. And I find";
		String text6 = "that lack of sleep enhances them both";
		...
		Font font = createFontToFit(new Font("Ubuntu", Font.BOLD, 60), text1, image);	
		FontMetrics metrics = g.getFontMetrics(font);
				
		int x = getX(image, text1, metrics);
		int y = getY(image, metrics)-80;
