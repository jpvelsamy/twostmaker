 ...
 *
 */
public class AlternatePlausibleTest {

	@Test
	public void createImage() throws IOException {

		String imagePath = this.getClass().getResource("512px-Hinweiszeichen_17a_empty.jpg").getPath();
		String text1 = "என்றும் குணம் மாறா ";	
		String text2 = "எங்கள் குணசீலன்";
		String text3 = "எங்கள் மக்கள்செல்வன்";
		String text4 = "வாழ்த்த வயதில்லை";
		String text5 = "வணங்குகிறேன்";
		...
		Font font = createFontToFit(new Font("Lohit-Tamil", Font.BOLD, 80), text1, image);
		...
		for (Iterator<String> iterator = textList.iterator(); iterator.hasNext();) {
			...
			AttributedString attributedText1 = createAttributedText(utf8EncodedString, font);
