...
public class ThankyouNote {
	...
	public void createImage() throws IOException {
		...
		String text1 = "Good morning Suresh...";
		String text2 = "Thanks for inspiring me to do ";
		String text3 = "many things, including writing ";
		String text4 = "code to generate this image...";
		String text5 = "Have a greate day ng Suresh...";
		...
		Font font = new Font("Ubuntu", Font.ITALIC, 30);
		FontMetrics metrics = g.getFontMetrics(font);
				
		int x = getX(image, text1, metrics)-40;
