...
//That’s how people learn — from meeting real people through one-on-one, one-on-three, one-on-four, and one-on-more.
public class OnWriting2FromLamportTest {

	@Test
	public void createImage() throws IOException {

		String imagePath = this.getClass().getResource("512px-Hinweiszeichen_17a_empty.jpg").getPath();
		String text1 = "Leslie lamport on writing--";
		String text2 = "To think you have to write, If you  ";
		String text3 = "are thinking without writing,";
		String text4 = "you only think you're thinking";
		...
		Font font = createFontToFit(new Font("Ubuntu", Font.BOLD, 50), text1, image);
