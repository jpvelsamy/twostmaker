...
public class OnWritingFromLamportTest {

	@Test
	public void createImage() throws IOException {

		String imagePath = this.getClass().getResource("512px-Hinweiszeichen_17a_empty.jpg").getPath();
		String text1 = "Leslie lamport quoting guindon--";
		String text2 = "Writing is nature's way of letting ";
		String text3 = "you know how sloppy your ";
		String text4 = "thinkingis... Write often, do it...";
