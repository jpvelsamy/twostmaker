 ...
 *
 */
public class KarthiWishingTest {

	@Test
	public void createImage() throws IOException {
		
		String imagePath = this.getClass().getResource("512px-Hinweiszeichen_17a_empty.jpg").getPath();
		String text1 = "The simple existence of an ";
		String text2 = "alternate plausible scenario";
		String text3 = "is often all that’s needed";
		String text4 = "to keep hope alive among";
		String text5 = "a worried workforce";
