...
public class FounderLedSales {

	@Test
	public void createImage() throws IOException {

		String imagePath = this.getClass().getResource("512px-Hinweiszeichen_17a_empty.jpg").getPath();
		String text1 = "Founder led sales, people learn —";
		String text2 = "from meeting real people through";
		String text3 = "one-on-one, one-on-three,";
		String text4 = "one-on-four, and one-on-more";
